            ...
            if ((block.canSustainPlant(state, world, pos, EnumFacing.UP, (BlockRubberSapling)ModRegistry.Blocks.rubberSapling)) &&
                    ...
                    for (xOffset = x - center; xOffset <= x + center; ++xOffset) {
                        ...
                        for (zOffset = z - center; zOffset <= z + center; ++zOffset) {
                            ...
                            if (((xPos != center | zPos != center) ||
                                ...
                                this.setBlockAndNotifyAdequately(world, pos, ModRegistry.Blocks.rubberLeaves.getDefaultState());
                            }
                        }
                    }
                }
                ...
                for (yOffset = 0; yOffset < treeHeight; ++yOffset) {
                    ...
                    if (block.isAir(state, world, pos) ||
                        ...
                        this.setBlockAndNotifyAdequately(world, pos, ModRegistry.Blocks.rubberWood.getDefaultState());
                    }
                }
